...
public class Page<T> implements IPage<T> {
    ...
    public Page(long current, long pageSize, boolean searchCount) {
        this(current, pageSize, 0, searchCount);
    }

    public Page(long current, long pageSize, long total, boolean searchCount) {
        if (current > 1) {
    ...
    public static <T> Page<T> copy(Page<?> page, Class<T> tClass) {
        return new Page<T>(page.getCurrent(), page.getPageSize(), page.getTotal());
    }
    ...
    public Page<T> setPageSize(long size) {
        this.pageSize = size;
        return this;
    }
